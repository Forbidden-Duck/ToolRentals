...
namespace ToolRentals {
    public partial class frmRentalList : Form {
        ...
        private void inkAddRental_Click(object sender, EventArgs e) {
        ...
        public void PopulateGrid() {
            ...
            string sqlQuery =
                "SELECT Rental.RentalID, Customer.CustomerName, Rental.Workshop, Rental.DateRented, Rental.DateReturned " +
