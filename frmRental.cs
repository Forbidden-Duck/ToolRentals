...
namespace ToolRentals {
    public partial class frmRental : Form {
        ...
        private void BindControls() {
            ...
            txtWorkshop.DataBindings.Add("Text", _dtable, "Workshop");
            ...
            cboCustomer.BindingContext = BindingContext;
        ...
        private void PopulateGrid() {
            // Create and assign a new SQL Query
            string sqlQuery =
                "SELECT RentalItem.RentalItemID, RentalItem.RentalID, Tool.Description " +
